            ...
            <div className="background">
                ...
                <div className="containerPerfil">
                    <div className="esquerda">
                        ...
                        {typeof listGames !== 'undefined' && listGames.map((value) => {
                            return value.cpf ? <p>CPF: {value.cpf}</p>
                                : <p>CPF: Sem Valor</p>
                        })}
                        {typeof listGames !== 'undefined' && listGames.map((value) => {
                            return value.rg ? <p>RG: {value.rg}</p>
                    ...
                    <div className="meio">
                        {typeof listGames !== 'undefined' && listGames.map((value) => {
                            return value.email ? <p>Email: {value.email}</p>
                                : <p>Email: Sem valor</p>
                        })}
                        
                        {typeof listGames !== 'undefined' && listGames.map((value) => {
                            return value.datanascimento ? <p>Data Nascimento: {value.datanascimento}</p>
                                : <p>Data Nascimento: Sem Valor</p>
                        })}
                    </div>
                    <div className="direito">
                        <a href="/lista" onClick={() => deleta()}><img src={Lixeira} alt="Lixeira" /></a>
                        {/* <a href="/a"> */}
